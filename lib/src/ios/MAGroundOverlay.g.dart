...
class MAGroundOverlay extends MAShape with MAOverlay, MAAnnotation {
  ...
  static Future<MAGroundOverlay> create__() async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_map_fluttify'))).invokeMethod('ObjectFactory::createMAGroundOverlay');
  ...
  static Future<List<MAGroundOverlay>> create_batch__(int length) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_map_fluttify'))).invokeMethod('ObjectFactory::create_batchMAGroundOverlay', {'length': length});
