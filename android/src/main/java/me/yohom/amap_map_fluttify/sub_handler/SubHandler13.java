...
public class SubHandler13 {
    public static Map<String, Handler> getSubHandler(BinaryMessenger messenger) {
        return new HashMap<String, Handler>() {{
            ...
            // factory
            put("ObjectFactory::create_batchcom_amap_api_maps_utils_PathSmoothTool__", (__argsBatch__, __methodResult__) -> {
                List<com.amap.api.maps.utils.PathSmoothTool> __resultList__ = new ArrayList<>();
                ...
                for (int __i__ = 0; __i__ < __length__; __i__++) {
                    ...
                    // create target object
                    com.amap.api.maps.utils.PathSmoothTool __obj__ = new com.amap.api.maps.utils.PathSmoothTool();
